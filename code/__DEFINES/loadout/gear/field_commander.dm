GLOBAL_LIST_INIT(commander_gear_listed_products, list(
	...
	/obj/item/implanter/hud/medical = list(CAT_FCSUP, "Medical HUD implanter", 3, "cyan2"),
	...
	/obj/item/armor_module/module/night_vision = list(CAT_FCSUP, "BE-35 night vision kit", 14, "blue"),
