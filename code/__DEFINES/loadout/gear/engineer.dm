GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
	...
	/obj/item/implanter/skill/firearms = list(CAT_ENGSUP, "Firearms skills implanter", 30, "cyan2"),
	/obj/item/implanter/skill/melee = list(CAT_ENGSUP, "CQC skills implanter", 30, "cyan2"),
	/obj/item/implanter/skill/engineer = list(CAT_ENGSUP, "Engineering skills implanter", 25, "cyan2"),
	/obj/item/implanter/skill/construct = list(CAT_ENGSUP, "Construction skills implanter", 25, "cyan2"),
	...
	/obj/item/tesla_turret = list(CAT_ENGSUP, "Tesla Turret", 30, "blue"),
	/obj/item/weapon/gun/hsg102 = list(CAT_ENGSUP, "HSG-102", 45, "blue"),
	...
	/obj/item/minerupgrade/overclock = list(CAT_ENGSUP, "Mining well overclock upgrade", 7, "blue"),
	/obj/item/minerupgrade/reinforcement = list(CAT_ENGSUP, "Mining well reinforcement upgrade", 7, "blue"),
	/obj/item/minerupgrade/automatic = list(CAT_ENGSUP, "Mining well automation upgrade", 7, "blue"),
